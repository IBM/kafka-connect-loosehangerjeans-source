...
public class Product {
     ...
     * The product short description does not include the size.
     * It is generated by concatenating the material, style and name properties separated by a space character.*/
